...
def unit(session, protobuf_implementation):
    ...
    session.run(
        ...
        "--cov=google/cloud/cloud/cloud/cloud/cloud/cloud/cloud/cloud/cloud/cloud/cloud/cloud/cloud/cloud/cloud/cloud/cloud/cloud/cloud/cloud/cloud/cloud/cloud/cloud/cloud/cloud/cloud/cloud",
        "--cov=tests/unit",
        "--cov-append",
