...
class SubscriberTransport(abc.ABC):
    ...
    def delete_subscription(
        ...
        [pubsub.DeleteSubscriptionRequest], Union[empty.Empty, Awaitable[empty.Empty]]
    ]:
        raise NotImplementedError()
    ...
    def modify_ack_deadline(
        ...
        [pubsub.ModifyAckDeadlineRequest], Union[empty.Empty, Awaitable[empty.Empty]]
    ]:
        raise NotImplementedError()
    ...
    def acknowledge(
        ...
        [pubsub.AcknowledgeRequest], Union[empty.Empty, Awaitable[empty.Empty]]
    ]:
        raise NotImplementedError()
    ...
    def modify_push_config(
        ...
        [pubsub.ModifyPushConfigRequest], Union[empty.Empty, Awaitable[empty.Empty]]
    ]:
        raise NotImplementedError()
    ...
    def delete_snapshot(
        ...
        [pubsub.DeleteSnapshotRequest], Union[empty.Empty, Awaitable[empty.Empty]]
    ]:
        raise NotImplementedError()
