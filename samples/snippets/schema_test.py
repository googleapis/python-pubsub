...
AVRO_TOPIC_ID = f"schema-test-avro-topic-{PY_VERSION}-{UUID}"
PROTO_TOPIC_ID = f"schema-test-proto-topic-{PY_VERSION}-{UUID}"
AVRO_SUBSCRIPTION_ID = f"schema-test-avro-subscription-{PY_VERSION}-{UUID}"
