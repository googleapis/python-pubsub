...
class SchemaServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_commit_schema(self, request: gp_schema.CommitSchemaRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gp_schema.CommitSchemaRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_commit_schema_with_metadata(self, response: gp_schema.Schema, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gp_schema.Schema, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for commit_schema
    ...
    def pre_create_schema(self, request: gp_schema.CreateSchemaRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gp_schema.CreateSchemaRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_schema_with_metadata(self, response: gp_schema.Schema, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gp_schema.Schema, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_schema
    ...
    def pre_delete_schema(self, request: schema.DeleteSchemaRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[schema.DeleteSchemaRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_delete_schema_revision(self, request: schema.DeleteSchemaRevisionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[schema.DeleteSchemaRevisionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_delete_schema_revision_with_metadata(self, response: schema.Schema, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[schema.Schema, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for delete_schema_revision
    ...
    def pre_get_schema(self, request: schema.GetSchemaRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[schema.GetSchemaRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_list_schema_revisions(self, request: schema.ListSchemaRevisionsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[schema.ListSchemaRevisionsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_schema_revisions_with_metadata(self, response: schema.ListSchemaRevisionsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[schema.ListSchemaRevisionsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_schema_revisions
    ...
    def pre_list_schemas(self, request: schema.ListSchemasRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[schema.ListSchemasRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_schemas_with_metadata(self, response: schema.ListSchemasResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[schema.ListSchemasResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_schemas
    ...
    def pre_rollback_schema(self, request: schema.RollbackSchemaRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[schema.RollbackSchemaRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_rollback_schema_with_metadata(self, response: schema.Schema, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[schema.Schema, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for rollback_schema
    ...
    def pre_validate_message(self, request: schema.ValidateMessageRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[schema.ValidateMessageRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_validate_message_with_metadata(self, response: schema.ValidateMessageResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[schema.ValidateMessageResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for validate_message
    ...
    def pre_validate_schema(self, request: gp_schema.ValidateSchemaRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gp_schema.ValidateSchemaRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_validate_schema_with_metadata(self, response: gp_schema.ValidateSchemaResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[gp_schema.ValidateSchemaResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for validate_schema
...
class SchemaServiceRestTransport(_BaseSchemaServiceRestTransport):
    ...
    class _CommitSchema(_BaseSchemaServiceRestTransport._BaseCommitSchema, SchemaServiceRestStub):
        ...
        def __call__(self,
            ...
            resp, _ = self._interceptor.post_commit_schema_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _DeleteSchemaRevision(_BaseSchemaServiceRestTransport._BaseDeleteSchemaRevision, SchemaServiceRestStub):
        ...
        def __call__(self,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_delete_schema_revision_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _ListSchemaRevisions(_BaseSchemaServiceRestTransport._BaseListSchemaRevisions, SchemaServiceRestStub):
        ...
        def __call__(self,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_list_schema_revisions_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = schema.ListSchemaRevisionsResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
    ...
    class _RollbackSchema(_BaseSchemaServiceRestTransport._BaseRollbackSchema, SchemaServiceRestStub):
        ...
        def __call__(self,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_rollback_schema_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = schema.Schema.to_json(response)
                except:
    ...
    class _ValidateMessage(_BaseSchemaServiceRestTransport._BaseValidateMessage, SchemaServiceRestStub):
        ...
        def __call__(self,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_validate_message_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
    ...
    class _ValidateSchema(_BaseSchemaServiceRestTransport._BaseValidateSchema, SchemaServiceRestStub):
        ...
        def __call__(self,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_validate_schema_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = gp_schema.ValidateSchemaResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
