...
class SubscriberAsyncClient:
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, SubscriberTransport, Callable[..., SubscriberTransport]]] = "grpc_asyncio",
    ...
    async def modify_ack_deadline(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.modify_ack_deadline]
    ...
    async def acknowledge(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.acknowledge]
    ...
    def streaming_pull(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.streaming_pull]
    ...
    async def modify_push_config(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.modify_push_config]
