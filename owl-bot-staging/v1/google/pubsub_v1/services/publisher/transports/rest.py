...
class PublisherRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_topic(self, request: pubsub.Topic, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[pubsub.Topic, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_create_topic_with_metadata(self, response: pubsub.Topic, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[pubsub.Topic, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for create_topic
    ...
    def pre_delete_topic(self, request: pubsub.DeleteTopicRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[pubsub.DeleteTopicRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def pre_detach_subscription(self, request: pubsub.DetachSubscriptionRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[pubsub.DetachSubscriptionRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_detach_subscription_with_metadata(self, response: pubsub.DetachSubscriptionResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[pubsub.DetachSubscriptionResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for detach_subscription
    ...
    def pre_get_topic(self, request: pubsub.GetTopicRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[pubsub.GetTopicRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_get_topic_with_metadata(self, response: pubsub.Topic, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[pubsub.Topic, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_topic
    ...
    def pre_list_topics(self, request: pubsub.ListTopicsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[pubsub.ListTopicsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_topics_with_metadata(self, response: pubsub.ListTopicsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[pubsub.ListTopicsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_topics
    ...
    def pre_list_topic_snapshots(self, request: pubsub.ListTopicSnapshotsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[pubsub.ListTopicSnapshotsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_topic_snapshots_with_metadata(self, response: pubsub.ListTopicSnapshotsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[pubsub.ListTopicSnapshotsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_topic_snapshots
    ...
    def pre_list_topic_subscriptions(self, request: pubsub.ListTopicSubscriptionsRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[pubsub.ListTopicSubscriptionsRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_topic_subscriptions_with_metadata(self, response: pubsub.ListTopicSubscriptionsResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[pubsub.ListTopicSubscriptionsResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_topic_subscriptions
    ...
    def pre_publish(self, request: pubsub.PublishRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[pubsub.PublishRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_publish_with_metadata(self, response: pubsub.PublishResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[pubsub.PublishResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for publish
    ...
    def pre_update_topic(self, request: pubsub.UpdateTopicRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[pubsub.UpdateTopicRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_update_topic_with_metadata(self, response: pubsub.Topic, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[pubsub.Topic, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for update_topic
...
class PublisherRestTransport(_BasePublisherRestTransport):
    ...
    class _DetachSubscription(_BasePublisherRestTransport._BaseDetachSubscription, PublisherRestStub):
        ...
        def __call__(self,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_detach_subscription_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = pubsub.DetachSubscriptionResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
    ...
    class _ListTopicSnapshots(_BasePublisherRestTransport._BaseListTopicSnapshots, PublisherRestStub):
        ...
        def __call__(self,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_list_topic_snapshots_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = pubsub.ListTopicSnapshotsResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
    ...
    class _ListTopicSubscriptions(_BasePublisherRestTransport._BaseListTopicSubscriptions, PublisherRestStub):
        ...
        def __call__(self,
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_list_topic_subscriptions_with_metadata(resp, response_metadata)
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(logging.DEBUG):  # pragma: NO COVER
                try:
                    response_payload = pubsub.ListTopicSubscriptionsResponse.to_json(response)
                except:
                    response_payload = None
                http_response = {
                "payload": response_payload,
