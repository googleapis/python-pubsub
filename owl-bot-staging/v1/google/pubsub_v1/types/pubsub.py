...
class IngestionDataSourceSettings(proto.Message):
    ...
    class CloudStorage(proto.Message):
        ...
        text_format: 'IngestionDataSourceSettings.CloudStorage.TextFormat' = proto.Field(
            proto.MESSAGE,
            number=3,
            oneof='input_format',
            message='IngestionDataSourceSettings.CloudStorage.TextFormat',
        )
        avro_format: 'IngestionDataSourceSettings.CloudStorage.AvroFormat' = proto.Field(
            proto.MESSAGE,
            number=4,
            oneof='input_format',
...
class IngestionFailureEvent(proto.Message):
    ...
    class CloudStorageFailure(proto.Message):
        ...
        schema_violation_reason: 'IngestionFailureEvent.SchemaViolationReason' = proto.Field(
            proto.MESSAGE,
            number=7,
            oneof='reason',
