...
def test_list_topic_snapshots_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_topic_snapshots in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_topic_snapshots] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_topic_snapshots_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = PublisherAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_topic_snapshots in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_topic_snapshots] = mock_rpc
...
def test_detach_subscription_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.detach_subscription in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.detach_subscription] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_detach_subscription_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = PublisherAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.detach_subscription in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.detach_subscription] = mock_rpc
...
def test_create_topic_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{name=projects/*/topics/*}" % client.transport._host, args[1])
...
def test_update_topic_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{topic.name=projects/*/topics/*}" % client.transport._host, args[1])
...
def test_publish_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{topic=projects/*/topics/*}:publish" % client.transport._host, args[1])
...
def test_get_topic_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{topic=projects/*/topics/*}" % client.transport._host, args[1])
...
def test_list_topics_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{project=projects/*}/topics" % client.transport._host, args[1])
...
def test_list_topic_subscriptions_rest_required_fields(request_type=pubsub.ListTopicSubscriptionsRequest):
    transport_class = transports.PublisherRestTransport
...
def test_list_topic_subscriptions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{topic=projects/*/topics/*}/subscriptions" % client.transport._host, args[1])
...
def test_list_topic_subscriptions_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(pubsub.ListTopicSubscriptionsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_list_topic_snapshots_rest_required_fields(request_type=pubsub.ListTopicSnapshotsRequest):
    transport_class = transports.PublisherRestTransport
...
def test_list_topic_snapshots_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{topic=projects/*/topics/*}/snapshots" % client.transport._host, args[1])
...
def test_detach_subscription_rest_required_fields(request_type=pubsub.DetachSubscriptionRequest):
    transport_class = transports.PublisherRestTransport
...
def test_create_topic_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.PublisherRestInterceptor, "post_create_topic") as post, \
        mock.patch.object(transports.PublisherRestInterceptor, "post_create_topic_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.PublisherRestInterceptor, "pre_create_topic") as pre:
...
def test_update_topic_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.PublisherRestInterceptor, "post_update_topic") as post, \
        mock.patch.object(transports.PublisherRestInterceptor, "post_update_topic_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.PublisherRestInterceptor, "pre_update_topic") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_get_topic_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.PublisherRestInterceptor, "post_get_topic") as post, \
        mock.patch.object(transports.PublisherRestInterceptor, "post_get_topic_with_metadata") as post_with_metadata, \
...
def test_list_topics_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.PublisherRestInterceptor, "post_list_topics") as post, \
        mock.patch.object(transports.PublisherRestInterceptor, "post_list_topics_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.PublisherRestInterceptor, "pre_list_topics") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
...
def test_list_topic_subscriptions_rest_bad_request(request_type=pubsub.ListTopicSubscriptionsRequest):
    client = PublisherClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_topic_subscriptions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.PublisherRestInterceptor, "post_list_topic_subscriptions") as post, \
        mock.patch.object(transports.PublisherRestInterceptor, "post_list_topic_subscriptions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.PublisherRestInterceptor, "pre_list_topic_subscriptions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = pubsub.ListTopicSubscriptionsRequest.pb(pubsub.ListTopicSubscriptionsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = pubsub.ListTopicSubscriptionsResponse.to_json(pubsub.ListTopicSubscriptionsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = pubsub.ListTopicSubscriptionsResponse(), metadata

        client.list_topic_subscriptions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_list_topic_snapshots_rest_bad_request(request_type=pubsub.ListTopicSnapshotsRequest):
    client = PublisherClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_topic_snapshots_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.PublisherRestInterceptor, "post_list_topic_snapshots") as post, \
        mock.patch.object(transports.PublisherRestInterceptor, "post_list_topic_snapshots_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.PublisherRestInterceptor, "pre_list_topic_snapshots") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = pubsub.ListTopicSnapshotsRequest.pb(pubsub.ListTopicSnapshotsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = pubsub.ListTopicSnapshotsResponse.to_json(pubsub.ListTopicSnapshotsResponse())
        req.return_value.content = return_value
        ...
        client.list_topic_snapshots(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_topic_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.PublisherRestInterceptor, "pre_delete_topic") as pre:
        pre.assert_not_called()
...
def test_detach_subscription_rest_bad_request(request_type=pubsub.DetachSubscriptionRequest):
    client = PublisherClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_detach_subscription_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.PublisherRestInterceptor, "post_detach_subscription") as post, \
        mock.patch.object(transports.PublisherRestInterceptor, "post_detach_subscription_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.PublisherRestInterceptor, "pre_detach_subscription") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = pubsub.DetachSubscriptionRequest.pb(pubsub.DetachSubscriptionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = pubsub.DetachSubscriptionResponse.to_json(pubsub.DetachSubscriptionResponse())
        req.return_value.content = return_value
        ...
        client.detach_subscription(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
