...
def test_list_schema_revisions_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.list_schema_revisions in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.list_schema_revisions] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_list_schema_revisions_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SchemaServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_schema_revisions in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_schema_revisions] = mock_rpc
...
async def test_list_schema_revisions_async(transport: str = 'grpc_asyncio', request_type=schema.ListSchemaRevisionsRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(schema.ListSchemaRevisionsResponse(
            next_page_token='next_page_token_value',
        ))
...
async def test_list_schema_revisions_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_schema_revisions(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_commit_schema(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.commit_schema),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = gp_schema.Schema(
            name='name_value',
...
@pytest.mark.asyncio
async def test_commit_schema_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SchemaServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.commit_schema in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.commit_schema] = mock_rpc
...
def test_rollback_schema(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.rollback_schema),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = schema.Schema(
            name='name_value',
...
@pytest.mark.asyncio
async def test_rollback_schema_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SchemaServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.rollback_schema in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.rollback_schema] = mock_rpc
...
def test_delete_schema_revision(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_schema_revision),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = schema.Schema(
            name='name_value',
...
def test_delete_schema_revision_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.delete_schema_revision in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.delete_schema_revision] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_delete_schema_revision_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SchemaServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_schema_revision in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_schema_revision] = mock_rpc
...
@pytest.mark.asyncio
async def test_validate_schema_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SchemaServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.validate_schema in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.validate_schema] = mock_rpc
...
def test_validate_message_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.validate_message] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_validate_message_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SchemaServiceAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.validate_message in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.validate_message] = mock_rpc
...
def test_create_schema_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*}/schemas" % client.transport._host, args[1])
...
def test_get_schema_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/schemas/*}" % client.transport._host, args[1])
...
def test_list_schema_revisions_rest_required_fields(request_type=schema.ListSchemaRevisionsRequest):
    transport_class = transports.SchemaServiceRestTransport
...
def test_list_schema_revisions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/schemas/*}:listRevisions" % client.transport._host, args[1])
...
def test_list_schema_revisions_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(schema.ListSchemaRevisionsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_commit_schema_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/schemas/*}:commit" % client.transport._host, args[1])
...
def test_rollback_schema_rest_required_fields(request_type=schema.RollbackSchemaRequest):
    transport_class = transports.SchemaServiceRestTransport
...
def test_rollback_schema_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/schemas/*}:rollback" % client.transport._host, args[1])
...
def test_delete_schema_revision_rest_required_fields(request_type=schema.DeleteSchemaRevisionRequest):
    transport_class = transports.SchemaServiceRestTransport
...
def test_delete_schema_revision_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/schemas/*}:deleteRevision" % client.transport._host, args[1])
...
def test_validate_schema_rest_required_fields(request_type=gp_schema.ValidateSchemaRequest):
    transport_class = transports.SchemaServiceRestTransport
...
def test_validate_schema_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*}/schemas:validate" % client.transport._host, args[1])
...
def test_validate_message_rest_required_fields(request_type=schema.ValidateMessageRequest):
    transport_class = transports.SchemaServiceRestTransport
...
def test_create_schema_rest_call_success(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1'}
    request_init["schema"] = {'name': 'name_value', 'type_': 1, 'definition': 'definition_value', 'revision_id': 'revision_id_value', 'revision_create_time': {'seconds': 751, 'nanos': 543}}
...
def test_list_schema_revisions_rest_bad_request(request_type=schema.ListSchemaRevisionsRequest):
    client = SchemaServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_schema_revisions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "post_list_schema_revisions") as post, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "post_list_schema_revisions_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "pre_list_schema_revisions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = schema.ListSchemaRevisionsRequest.pb(schema.ListSchemaRevisionsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = schema.ListSchemaRevisionsResponse.to_json(schema.ListSchemaRevisionsResponse())
        req.return_value.content = return_value
        ...
        client.list_schema_revisions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_commit_schema_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "post_commit_schema") as post, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "post_commit_schema_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "pre_commit_schema") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.commit_schema(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_rollback_schema_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "post_rollback_schema") as post, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "post_rollback_schema_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "pre_rollback_schema") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        client.rollback_schema(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_delete_schema_revision_rest_bad_request(request_type=schema.DeleteSchemaRevisionRequest):
    client = SchemaServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_delete_schema_revision_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "post_delete_schema_revision") as post, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "post_delete_schema_revision_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "pre_delete_schema_revision") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = schema.DeleteSchemaRevisionRequest.pb(schema.DeleteSchemaRevisionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.delete_schema_revision(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_validate_schema_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "post_validate_schema") as post, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "post_validate_schema_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "pre_validate_schema") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = gp_schema.ValidateSchemaRequest.pb(gp_schema.ValidateSchemaRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = gp_schema.ValidateSchemaResponse.to_json(gp_schema.ValidateSchemaResponse())
        req.return_value.content = return_value
        ...
        client.validate_schema(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_validate_message_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        mock.patch.object(path_template, "transcode")  as transcode, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "post_validate_message") as post, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "post_validate_message_with_metadata") as post_with_metadata, \
        mock.patch.object(transports.SchemaServiceRestInterceptor, "pre_validate_message") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = schema.ValidateMessageResponse.to_json(schema.ValidateMessageResponse())
        req.return_value.content = return_value
        ...
        client.validate_message(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
