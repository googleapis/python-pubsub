...
def test__read_environment_variables():
    ...
    with mock.patch.dict(os.environ, {"GOOGLE_CLOUD_UNIVERSE_DOMAIN": "foo.com"}):
        assert SubscriberClient._read_environment_variables() == (False, "auto", "foo.com")
...
def test__get_client_cert_source():
    ...
    assert SubscriberClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert SubscriberClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert SubscriberClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert SubscriberClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(SubscriberClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SubscriberClient))
@mock.patch.object(SubscriberAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SubscriberAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = SubscriberClient._DEFAULT_UNIVERSE
    default_endpoint = SubscriberClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = SubscriberClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert SubscriberClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert SubscriberClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == SubscriberClient.DEFAULT_MTLS_ENDPOINT
    assert SubscriberClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert SubscriberClient._get_api_endpoint(None, None, default_universe, "always") == SubscriberClient.DEFAULT_MTLS_ENDPOINT
    assert SubscriberClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == SubscriberClient.DEFAULT_MTLS_ENDPOINT
    assert SubscriberClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert SubscriberClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        SubscriberClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert SubscriberClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert SubscriberClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert SubscriberClient._get_universe_domain(None, None) == SubscriberClient._DEFAULT_UNIVERSE
...
def test_modify_ack_deadline_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.modify_ack_deadline in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.modify_ack_deadline] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_modify_ack_deadline_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SubscriberAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.modify_ack_deadline in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.modify_ack_deadline] = mock_object
...
@pytest.mark.asyncio
async def test_acknowledge_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SubscriberAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.acknowledge in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.acknowledge] = mock_object
...
async def test_pull_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.pull in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.pull] = mock_object
...
@pytest.mark.asyncio
async def test_streaming_pull_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SubscriberAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.streaming_pull in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.streaming_pull] = mock_object
...
def test_modify_push_config_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.modify_push_config in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.modify_push_config] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_modify_push_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SubscriberAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.modify_push_config in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.modify_push_config] = mock_object
...
async def test_seek_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.seek in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.seek] = mock_object
...
def test_create_subscription_rest_unset_required_fields():
    transport = transports.SubscriberRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.create_subscription._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("name", "topic", )))
...
def test_create_subscription_rest_interceptors(null_interceptor):
    transport = transports.SubscriberRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.SubscriberRestInterceptor(),
        )
    client = SubscriberClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SubscriberRestInterceptor, "post_create_subscription") as post, \
         mock.patch.object(transports.SubscriberRestInterceptor, "pre_create_subscription") as pre:
...
def test_create_subscription_rest_bad_request(transport: str = 'rest', request_type=pubsub.Subscription):
    client = SubscriberClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_subscription_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{name=projects/*/subscriptions/*}" % client.transport._host, args[1])
...
def test_get_subscription_rest_required_fields(request_type=pubsub.GetSubscriptionRequest):
    transport_class = transports.SubscriberRestTransport
...
def test_get_subscription_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SubscriberRestInterceptor, "post_get_subscription") as post, \
         mock.patch.object(transports.SubscriberRestInterceptor, "pre_get_subscription") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_subscription_rest_bad_request(transport: str = 'rest', request_type=pubsub.GetSubscriptionRequest):
    client = SubscriberClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_subscription_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{subscription=projects/*/subscriptions/*}" % client.transport._host, args[1])
...
def test_update_subscription_rest_required_fields(request_type=pubsub.UpdateSubscriptionRequest):
    transport_class = transports.SubscriberRestTransport
...
def test_update_subscription_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("subscription", "updateMask", )))
...
def test_update_subscription_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SubscriberRestInterceptor, "post_update_subscription") as post, \
         mock.patch.object(transports.SubscriberRestInterceptor, "pre_update_subscription") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = pubsub.UpdateSubscriptionRequest.pb(pubsub.UpdateSubscriptionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_update_subscription_rest_bad_request(transport: str = 'rest', request_type=pubsub.UpdateSubscriptionRequest):
    client = SubscriberClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_subscription_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'subscription': {'name': 'projects/sample1/subscriptions/sample2'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{subscription.name=projects/*/subscriptions/*}" % client.transport._host, args[1])
...
def test_list_subscriptions_rest_required_fields(request_type=pubsub.ListSubscriptionsRequest):
    transport_class = transports.SubscriberRestTransport
...
def test_list_subscriptions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SubscriberRestInterceptor, "post_list_subscriptions") as post, \
         mock.patch.object(transports.SubscriberRestInterceptor, "pre_list_subscriptions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = pubsub.ListSubscriptionsRequest.pb(pubsub.ListSubscriptionsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = pubsub.ListSubscriptionsResponse.to_json(pubsub.ListSubscriptionsResponse())
...
def test_list_subscriptions_rest_bad_request(transport: str = 'rest', request_type=pubsub.ListSubscriptionsRequest):
    client = SubscriberClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_subscriptions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{project=projects/*}/subscriptions" % client.transport._host, args[1])
...
def test_delete_subscription_rest_required_fields(request_type=pubsub.DeleteSubscriptionRequest):
    transport_class = transports.SubscriberRestTransport
...
def test_delete_subscription_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SubscriberRestInterceptor, "pre_delete_subscription") as pre:
        pre.assert_not_called()
        pb_message = pubsub.DeleteSubscriptionRequest.pb(pubsub.DeleteSubscriptionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
...
def test_delete_subscription_rest_bad_request(transport: str = 'rest', request_type=pubsub.DeleteSubscriptionRequest):
    client = SubscriberClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_modify_ack_deadline_rest_required_fields(request_type=pubsub.ModifyAckDeadlineRequest):
    transport_class = transports.SubscriberRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).modify_ack_deadline._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_modify_ack_deadline_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("subscription", "ackIds", "ackDeadlineSeconds", )))
...
def test_modify_ack_deadline_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SubscriberRestInterceptor, "pre_modify_ack_deadline") as pre:
        pre.assert_not_called()
        pb_message = pubsub.ModifyAckDeadlineRequest.pb(pubsub.ModifyAckDeadlineRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.modify_ack_deadline(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_modify_ack_deadline_rest_bad_request(transport: str = 'rest', request_type=pubsub.ModifyAckDeadlineRequest):
    client = SubscriberClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_modify_ack_deadline_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{subscription=projects/*/subscriptions/*}:modifyAckDeadline" % client.transport._host, args[1])
...
def test_acknowledge_rest_required_fields(request_type=pubsub.AcknowledgeRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).acknowledge._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_acknowledge_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("subscription", "ackIds", )))
...
def test_acknowledge_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SubscriberRestInterceptor, "pre_acknowledge") as pre:
        pre.assert_not_called()
        ...
        client.acknowledge(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_acknowledge_rest_bad_request(transport: str = 'rest', request_type=pubsub.AcknowledgeRequest):
    client = SubscriberClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_acknowledge_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{subscription=projects/*/subscriptions/*}:acknowledge" % client.transport._host, args[1])
...
def test_pull_rest_required_fields(request_type=pubsub.PullRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).pull._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_pull_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("subscription", "maxMessages", )))
...
def test_pull_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.pull(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_pull_rest_bad_request(transport: str = 'rest', request_type=pubsub.PullRequest):
    client = SubscriberClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_pull_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{subscription=projects/*/subscriptions/*}:pull" % client.transport._host, args[1])
...
def test_modify_push_config_rest_required_fields(request_type=pubsub.ModifyPushConfigRequest):
    transport_class = transports.SubscriberRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).modify_push_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_modify_push_config_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("subscription", "pushConfig", )))
...
def test_modify_push_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SubscriberRestInterceptor, "pre_modify_push_config") as pre:
        pre.assert_not_called()
        ...
        client.modify_push_config(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_modify_push_config_rest_bad_request(transport: str = 'rest', request_type=pubsub.ModifyPushConfigRequest):
    client = SubscriberClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_modify_push_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{subscription=projects/*/subscriptions/*}:modifyPushConfig" % client.transport._host, args[1])
...
def test_get_snapshot_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SubscriberRestInterceptor, "post_get_snapshot") as post, \
         mock.patch.object(transports.SubscriberRestInterceptor, "pre_get_snapshot") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_snapshot_rest_bad_request(transport: str = 'rest', request_type=pubsub.GetSnapshotRequest):
    client = SubscriberClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_snapshot_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{snapshot=projects/*/snapshots/*}" % client.transport._host, args[1])
...
def test_list_snapshots_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SubscriberRestInterceptor, "post_list_snapshots") as post, \
         mock.patch.object(transports.SubscriberRestInterceptor, "pre_list_snapshots") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = pubsub.ListSnapshotsResponse.to_json(pubsub.ListSnapshotsResponse())
...
def test_list_snapshots_rest_bad_request(transport: str = 'rest', request_type=pubsub.ListSnapshotsRequest):
    client = SubscriberClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_snapshots_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{project=projects/*}/snapshots" % client.transport._host, args[1])
...
def test_create_snapshot_rest_required_fields(request_type=pubsub.CreateSnapshotRequest):
    transport_class = transports.SubscriberRestTransport
...
def test_create_snapshot_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("name", "subscription", )))
...
def test_create_snapshot_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SubscriberRestInterceptor, "post_create_snapshot") as post, \
         mock.patch.object(transports.SubscriberRestInterceptor, "pre_create_snapshot") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_snapshot_rest_bad_request(transport: str = 'rest', request_type=pubsub.CreateSnapshotRequest):
    client = SubscriberClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_snapshot_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/snapshots/*}" % client.transport._host, args[1])
...
def test_update_snapshot_rest_required_fields(request_type=pubsub.UpdateSnapshotRequest):
    transport_class = transports.SubscriberRestTransport
...
def test_update_snapshot_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("snapshot", "updateMask", )))
...
def test_update_snapshot_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SubscriberRestInterceptor, "post_update_snapshot") as post, \
         mock.patch.object(transports.SubscriberRestInterceptor, "pre_update_snapshot") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_snapshot_rest_bad_request(transport: str = 'rest', request_type=pubsub.UpdateSnapshotRequest):
    client = SubscriberClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_snapshot_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{snapshot.name=projects/*/snapshots/*}" % client.transport._host, args[1])
...
def test_delete_snapshot_rest_required_fields(request_type=pubsub.DeleteSnapshotRequest):
    transport_class = transports.SubscriberRestTransport
...
def test_delete_snapshot_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SubscriberRestInterceptor, "pre_delete_snapshot") as pre:
        pre.assert_not_called()
...
def test_delete_snapshot_rest_bad_request(transport: str = 'rest', request_type=pubsub.DeleteSnapshotRequest):
    client = SubscriberClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_seek_rest_required_fields(request_type=pubsub.SeekRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).seek._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_seek_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.seek(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_seek_rest_bad_request(transport: str = 'rest', request_type=pubsub.SeekRequest):
    client = SubscriberClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_iam_policy_rest_bad_request(transport: str = 'rest', request_type=iam_policy_pb2.GetIamPolicyRequest):
    ...
    request = request_type()
    request = json_format.ParseDict({'resource': 'projects/sample1/topics/sample2'}, request)
...
def test_test_iam_permissions_rest_bad_request(transport: str = 'rest', request_type=iam_policy_pb2.TestIamPermissionsRequest):
    ...
    request = request_type()
    request = json_format.ParseDict({'resource': 'projects/sample1/subscriptions/sample2'}, request)
