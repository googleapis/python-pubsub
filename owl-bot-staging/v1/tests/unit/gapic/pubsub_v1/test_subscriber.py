...
async def test_modify_ack_deadline_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.modify_ack_deadline] = mock_rpc
...
async def test_acknowledge_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.acknowledge] = mock_rpc
...
async def test_pull_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.pull] = mock_rpc
...
async def test_streaming_pull_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.streaming_pull] = mock_rpc
...
async def test_modify_push_config_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.modify_push_config] = mock_rpc
...
async def test_seek_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.seek] = mock_rpc
...
def test_create_subscription_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SubscriberRestInterceptor, "post_create_subscription_with_metadata") as post_with_metadata, \
...
def test_get_subscription_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SubscriberRestInterceptor, "post_get_subscription_with_metadata") as post_with_metadata, \
...
def test_update_subscription_rest_bad_request(request_type=pubsub.UpdateSubscriptionRequest):
    client = SubscriberClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_update_subscription_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SubscriberRestInterceptor, "post_update_subscription_with_metadata") as post_with_metadata, \
...
def test_list_subscriptions_rest_bad_request(request_type=pubsub.ListSubscriptionsRequest):
    client = SubscriberClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_list_subscriptions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SubscriberRestInterceptor, "post_list_subscriptions_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = pubsub.ListSubscriptionsResponse.to_json(pubsub.ListSubscriptionsResponse())
        req.return_value.content = return_value
...
def test_delete_subscription_rest_bad_request(request_type=pubsub.DeleteSubscriptionRequest):
    client = SubscriberClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_modify_ack_deadline_rest_bad_request(request_type=pubsub.ModifyAckDeadlineRequest):
    client = SubscriberClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_pull_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SubscriberRestInterceptor, "post_pull_with_metadata") as post_with_metadata, \
...
def test_modify_push_config_rest_bad_request(request_type=pubsub.ModifyPushConfigRequest):
    client = SubscriberClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_get_snapshot_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SubscriberRestInterceptor, "post_get_snapshot_with_metadata") as post_with_metadata, \
...
def test_list_snapshots_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SubscriberRestInterceptor, "post_list_snapshots_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = pubsub.ListSnapshotsResponse.to_json(pubsub.ListSnapshotsResponse())
        req.return_value.content = return_value
...
def test_create_snapshot_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SubscriberRestInterceptor, "post_create_snapshot_with_metadata") as post_with_metadata, \
...
def test_update_snapshot_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SubscriberRestInterceptor, "post_update_snapshot_with_metadata") as post_with_metadata, \
...
def test_seek_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SubscriberRestInterceptor, "post_seek_with_metadata") as post_with_metadata, \
