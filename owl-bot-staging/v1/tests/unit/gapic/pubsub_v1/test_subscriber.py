...
def test_create_subscription_rest_required_fields(request_type=pubsub.Subscription):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).create_subscription._get_unset_required_fields(jsonified_request)
...
def test_create_subscription_rest_unset_required_fields():
    transport = transports.SubscriberRestTransport(credentials=_AnonymousCredentialsWithUniverseDomain)
...
def test_get_subscription_rest_required_fields(request_type=pubsub.GetSubscriptionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).get_subscription._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_subscription_rest_required_fields(request_type=pubsub.UpdateSubscriptionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).update_subscription._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_subscriptions_rest_required_fields(request_type=pubsub.ListSubscriptionsRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).list_subscriptions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_subscription_rest_required_fields(request_type=pubsub.DeleteSubscriptionRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).delete_subscription._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_modify_ack_deadline_rest_required_fields(request_type=pubsub.ModifyAckDeadlineRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).modify_ack_deadline._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_acknowledge_rest_required_fields(request_type=pubsub.AcknowledgeRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).acknowledge._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_pull_rest_required_fields(request_type=pubsub.PullRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).pull._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_modify_push_config_rest_required_fields(request_type=pubsub.ModifyPushConfigRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).modify_push_config._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_seek_rest_required_fields(request_type=pubsub.SeekRequest):
    ...
    unset_fields = transport_class(credentials=_AnonymousCredentialsWithUniverseDomain()).seek._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
